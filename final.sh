#!/usr/bin/env bash
#SBATCH --job-name final # CHANGE this to a name of your choice
...
#SBATCH --nodelist=nv-ai-01.srv.aau.dk # CHANGE this to nodename of your choice$
#SBATCH --mem=300G
...
srun singularity exec --nv fs3c.sif python tools/train_net.py --num-gpus 2 --config-file configs/PascalVOC-detection/split1/faster_rcnn_R_101_FPN_ft_all1_1shot.yaml
srun singularity exec --nv fs3c.sif python tools/train_net.py --num-gpus 2 --config-file configs/PascalVOC-detection/split1/faster_rcnn_R_101_FPN_ft_all1_2shot.yaml
srun singularity exec --nv fs3c.sif python tools/train_net.py --num-gpus 2 --config-file configs/PascalVOC-detection/split1/faster_rcnn_R_101_FPN_ft_all1_3shot.yaml
srun singularity exec --nv fs3c.sif python tools/train_net.py --num-gpus 2 --config-file configs/PascalVOC-detection/split1/faster_rcnn_R_101_FPN_ft_all1_5shot.yaml